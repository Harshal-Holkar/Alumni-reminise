...
function App() {
  ...
  const handleChange = (e) => {
    ...
    for (var i = 0; i < e.target.files.length; i++) {
      ...
      setImgUploads((prevState) => [...prevState, imageFile]);
    }
  };
        ...
        <div className='thankYou hide'> Thank you for your Time</div>
          ...
          <div className="formbold-input-flex">
            <div>
              ...
              />
              <label htmlFor="lastname" className="formbold-form-label"> Hostel </label>
            </div>
            <div>
              <input
                type="text"
              ...
              />
              <label htmlFor="phone" className="formbold-form-label"> Year of Passing </label>
            </div>
          </div>
          ...
          <div className="formbold-textarea">
            ...
            ></textarea>
            <label htmlFor="message" className="formbold-form-label"> Your reminisce of Rendezvous/ Cult GC/ Sports GC</label>
          </div>
